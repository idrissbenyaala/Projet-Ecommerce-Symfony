...
/* command/list.html.twig */
class __TwigTemplate_bc55625633bf5c071a8869531a4c9fb3 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "command/list.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "command/list.html.twig"));

        $this->parent = $this->loadTemplate("base.html.twig", "command/list.html.twig", 1);
...
\t\t\t\t\t<li class=\"nav-item\"><a href=\"";
        ...
        echo "\" class=\"nav-link active\"><i class=\"ph-layout\"></i>Commands</a></li>
...
\t\t\t\t\t\t\t    ";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["commands"]) || array_key_exists("commands", $context) ? $context["commands"] : (function () { throw new RuntimeError('Variable "commands" does not exist.', 684, $this->source); })()));
        $context['loop'] = [
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["command"]) {
            ...
            echo "                                <tr>
                                    <td>";
            // line 686
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["command"], "id", [], "any", false, false, false, 686), "html", null, true);
            echo "</td>
                                    <td>";
            // line 687
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["command"], "firstname", [], "any", false, false, false, 687), "html", null, true);
            echo "</td>
                                    <td>";
            // line 688
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["command"], "lastname", [], "any", false, false, false, 688), "html", null, true);
            echo "</td>
                                    <td>";
            // line 689
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["command"], "number", [], "any", false, false, false, 689), "html", null, true);
            echo "</td>
                                    <td>";
            // line 690
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["command"], "address", [], "any", false, false, false, 690), "html", null, true);
            echo "</td>
                                    <td>";
            // line 691
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["command"], "email", [], "any", false, false, false, 691), "html", null, true);
            echo "</td>
                                    <td>
                                    ";
            // line 693
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, $context["command"], "product", [], "any", false, false, false, 693));
            foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
                // line 694
                echo "                                        ";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["product"], "name", [], "any", false, false, false, 694), "html", null, true);
                echo " / ";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["product"], "quantity", [], "any", false, false, false, 694), "html", null, true);
                echo " <!-- Assuming you have a 'quantity' property in your \$cartProduct array -->
                                        <br>
                                    ";
            }
...
\t\t\t\t\t\t\t\t\t\t\t";
            // line 700
            echo twig_include($this->env, $context, "command/_delete_form.html.twig");
            echo "   
                                        </td>
...
{% block title %}Commands index{% endblock %}
...
\t\t\t\t\t<li class=\"nav-item\"><a href=\"{{path ('app_command_index')}}\" class=\"nav-link active\"><i class=\"ph-layout\"></i>Commands</a></li>
...
\t\t\t\t\t\t\t    {% for command in commands %}
                                <tr>
                                    ...
                                    {% for product in command.product %}
                                        {{ product.name }} / {{ product.quantity }} <!-- Assuming you have a 'quantity' property in your \$cartProduct array -->
                                        <br>
                                    {% endfor %}
</td>
...
\t\t\t\t\t\t\t\t\t\t\t{{ include('command/_delete_form.html.twig') }}   
                                  ...
                                  {# <td style=\"width: 25px;\">
                                            <a href=\"{{ path('app_product_edit', {'id': command.id}) }}\"><i class=\"ph-pencil\"></i></a>
...
{% endblock %}
", "command/list.html.twig", "C:\\xampp\\htdocs\\projettt\\proj1\\templates\\command\\list.html.twig");
    }
}
