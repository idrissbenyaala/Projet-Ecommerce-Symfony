...
class __TwigTemplate_0c9a48fee333cec989c18638c26a871c extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t<a href=\"";
        ...
        echo "\" class=\"btn btn-primary btn-lg\">Add Category</a>
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t</div>
\t\t\t\t\t\t
\t\t\t<br>
...
\t\t\t\t\t\t<table class=\"table datatable-dom-position\">
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["categories"]) || array_key_exists("categories", $context) ? $context["categories"] : (function () { throw new RuntimeError('Variable "categories" does not exist.', 678, $this->source); })()));
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["category"]) {
            ...
            echo "                                    <tr>
                                        <td>";
            // line 680
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["category"], "id", [], "any", false, false, false, 680), "html", null, true);
            echo "</td>
                                        <td>";
            // line 681
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["category"], "name", [], "any", false, false, false, 681), "html", null, true);
            echo "</td>
                                        <td style=\"width: 15px;\">
                                            <a href=\"";
            // line 683
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_category_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["category"], "id", [], "any", false, false, false, 683)]), "html", null, true);
            echo "\"><i class=\"ph-pencil\"></i></a><td>
\t\t\t\t\t\t\t\t\t\t\t";
            // line 684
...
\t<!-- /demo config -->
    ...
    {
        return array (  651 => 759,  648 => 757,  645 => 742,  636 => 692,  627 => 688,  610 => 684,  606 => 683,  601 => 681,  597 => 680,  594 => 679,  576 => 678,  558 => 663,  536 => 643,  533 => 638,  531 => 630,  527 => 624,  523 => 618,  512 => 605,  508 => 602,  499 => 595,  488 => 568,  481 => 564,  431 => 517,  427 => 516,  423 => 515,  419 => 514,  409 => 507,  356 => 457,  349 => 452,  334 => 435,  325 => 431,  321 => 429,  315 => 424,  308 => 413,  305 => 404,  302 => 376,  291 => 352,  285 => 345,  282 => 328,  279 => 311,  276 => 299,  271 => 284,  267 => 266,  264 => 260,  261 => 255,  257 => 250,  251 => 239,  240 => 224,  236 => 212,  233 => 200,  230 => 188,  227 => 176,  223 => 162,  202 => 138,  198 => 125,  191 => 116,  188 => 106,  185 => 96,  182 => 86,  177 => 74,  140 => 35,  136 => 34,  131 => 32,  124 => 28,  120 => 27,  113 => 23,  109 => 22,  105 => 21,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t<div class=\"col col-auto ml-auto\">
\t\t\t\t\t\t\t\t<a href=\"{{path('app_category_new')}}\" class=\"btn btn-primary btn-lg\">Add Category</a>
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t</div>
\t\t\t\t\t\t
\t\t\t<br>
...
\t\t\t\t\t\t<table class=\"table datatable-dom-position\">
                                ...
                                {% for category in categories %}
                                    <tr>
                                        ...
                                        <td>{{ category.name }}</td>
                                        <td style=\"width: 15px;\">
                                            <a href=\"{{ path('app_category_edit', {'id': category.id}) }}\"><i class=\"ph-pencil\"></i></a><td>
...
{% endblock %}
", "category/index.html.twig", "C:\\xampp\\htdocs\\projettt\\proj1\\templates\\category\\index.html.twig");
    }
}
